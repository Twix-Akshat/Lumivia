...
export default function PatientProfilePage() {
  ...
  const optionalFields = ["phoneNumber", "dateOfBirth", "gender", "aboutBio"] as const
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 py-8 px-4 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-2xl">
        {/* Header */}
        <div className="mb-8">
          <Link href="/dashboard/patient" className="inline-flex items-center text-sm text-slate-600 hover:text-slate-900 mb-6">
            ← Back to Dashboard
          </Link>
          <h1 className="text-3xl font-bold text-slate-900 mb-2">Complete Your Profile</h1>
          <p className="text-slate-600">Set up your profile to get started with consultations</p>
        </div>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-6 mb-8">
          ...
          <div className="mt-4 space-y-2">
            <div className="flex items-start gap-3">
              ...
              <span className="text-sm text-slate-700"><span className="font-medium">Required fields:</span> Full name, Profile picture</span>
            </div>
            <div className="flex items-start gap-3">
              <AlertCircle className="w-5 h-5 text-blue-500 flex-shrink-0 mt-0.5" />
              <span className="text-sm text-slate-700"><span className="font-medium">Optional fields:</span> Phone, Date of birth, Gender, About you</span>
            </div>
          </div>
        </div>
            ...
            <div className="space-y-5">
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="Tell us a bit about yourself, your interests, or anything you'd like your therapist to know..."
                  rows={4}
